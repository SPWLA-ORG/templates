...
\def\headername{{SPWLA 64$^\textbf{th}$ Annual Logging Symposium, June 10--14, 2023}}
...
\noindent \parbox[t]{75mm}{ \scriptsize \rmfamily \noindent
	...
	Copyright 2023, held jointly by the Society of Petrophysicists and Well Log Analysts (SPWLA) and the submitting authors.
	
	This paper was prepared for the SPWLA 64$^\text{th}$ Annual Logging
        Symposium held in Lake Conroe, TX, USA, June 10--14, 2023.
}
...
The deadline for draft paper submission is March 27, 2023.

The deadline for final paper submission is April 24, 2023.
