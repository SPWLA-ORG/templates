...
\def\headername{{SPWLA 67$^\textbf{th}$ Annual Logging Symposium, May 16--20, 2026}}
...
\noindent \parbox[t]{75mm}{ \scriptsize \rmfamily \noindent
	...
	Copyright 2026, held jointly by the Society of Petrophysicists and Well Log Analysts (SPWLA) and the submitting authors.
	
	This paper was prepared for presentation at the SPWLA 67$^\text{th}$ Annual Logging
        Symposium held in Lake Conroe, TX, USA, May 16--20, 2026.
}
...
The deadline for DRAFT paper submission is March 2, 2026.

The deadline for FINAL paper submission is April 1, 2026.
...
The deadline for draft paper submission is March 2, 2026 and the deadline for final
paper submission is April 1, 2026. Please do not use security coding (passwords) when sending the PDF file. We do recommend that you submit earlier, so that there is time to make any corrections if the committee finds issues with the formatting. A manuscript with formatting issues will be returned for revision if time permits or removed from the program if time does not permit corrections.
...
\begin{itemize}
    ...
    \item Abstract (maximum 600 words)
...
Header. All pages must have the following header: “SPWLA 67th Annual Logging
Symposium, May 16--20, 2026” This header should be on the right side of odd pages and the left side of even pages, and be in 10-point Bold Times New Roman font (or the closest approximation possible).
...
accepted after the April 1, 2026 deadline.
...
Business Office (stephanie@spwla.org) or Robin Slocombe, SPWLA Vice President Technology at
...
\begin{wrapfigure}{l}{0.33\linewidth}
	\includegraphics[width=1.0\linewidth]{SPWLA-2026-Logo.png}
	%\vspace{0.03in}
\end{wrapfigure}
