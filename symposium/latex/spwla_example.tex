...
\noindent \parbox[t]{75mm}{ \scriptsize \rmfamily \noindent
	...
	This paper was prepared for the SPWLA 65$^\text{th}$ Annual Logging
        Symposium held in Rio de Janeiro, Brazil, May 18--22, 2024.
}
...
The deadline for DRAFT paper submission is March 11, 2024.

The deadline for FINAL paper submission is April 15, 2024.
...
The deadline for draft paper submission is March 11, 2024 and the deadline for final
paper submission is April 15, 2024. Please do not use security coding (passwords) when sending the PDF file. We do recommend that you submit earlier, so that there is time to make any corrections if the committee finds issues with the formatting. A manuscript with formatting issues will be returned for revision if time permits or removed from the program if time does not permit corrections.
...
Header. All pages must have the following header: “SPWLA 65th Annual Logging
Symposium, May 18--22, 2024” This header should be on the right side of odd pages and the left side of even pages, and be in 10-point Bold Times New Roman font (or the closest approximation possible).
...
accepted after the April 15, 2024 deadline.
...
Business Office (stephanie@spwla.org) or Robert (Bob) Gales, SPWLA Vice President Technology 
...
\begin{wrapfigure}{l}{0.33\linewidth}
	\includegraphics[width=1.0\linewidth]{SPWLA-2024-Logo.png}
	\vspace{0.03in}
\end{wrapfigure}
